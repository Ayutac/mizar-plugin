...
public class MizarTypeExpressionImpl extends ASTWrapperPsiElement implements MizarTypeExpression {

  public MizarTypeExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public MizarRadixType getRadixType() {
    return findNotNullChildByClass(MizarRadixType.class);
  }
