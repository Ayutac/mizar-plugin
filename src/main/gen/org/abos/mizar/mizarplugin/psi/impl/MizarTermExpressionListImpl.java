...
public class MizarTermExpressionListImpl extends ASTWrapperPsiElement implements MizarTermExpressionList {

  public MizarTermExpressionListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MizarVisitor visitor) {
    visitor.visitTermExpressionList(this);
  }
