...
public class MizarReasoningItemImpl extends ASTWrapperPsiElement implements MizarReasoningItem {

  public MizarReasoningItemImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MizarVisitor visitor) {
    visitor.visitReasoningItem(this);
  }
  ...
  @Override
  @Nullable
  public MizarSkeletonItem getSkeletonItem() {
    return findChildByClass(MizarSkeletonItem.class);
  }
