...
public class MizarVocabularyNameImpl extends ASTWrapperPsiElement implements MizarVocabularyName {

  public MizarVocabularyNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MizarVisitor visitor) {
    visitor.visitVocabularyName(this);
  }
  ...
  public PsiElement getFilename() {
    return findNotNullChildByType(FILENAME);
  }
