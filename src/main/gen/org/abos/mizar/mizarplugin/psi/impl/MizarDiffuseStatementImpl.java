...
public class MizarDiffuseStatementImpl extends ASTWrapperPsiElement implements MizarDiffuseStatement {

  public MizarDiffuseStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MizarVisitor visitor) {
    visitor.visitDiffuseStatement(this);
  }
