...
public class MizarSchemePremiseImpl extends ASTWrapperPsiElement implements MizarSchemePremise {

  public MizarSchemePremiseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MizarVisitor visitor) {
    visitor.visitSchemePremise(this);
  }
