...
public class MizarSupposeImpl extends ASTWrapperPsiElement implements MizarSuppose {

  public MizarSupposeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MizarVisitor visitor) {
    visitor.visitSuppose(this);
  }
