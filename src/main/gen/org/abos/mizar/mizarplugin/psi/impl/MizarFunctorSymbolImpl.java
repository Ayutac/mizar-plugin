...
public class MizarFunctorSymbolImpl extends ASTWrapperPsiElement implements MizarFunctorSymbol {

  public MizarFunctorSymbolImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MizarVisitor visitor) {
    visitor.visitFunctorSymbol(this);
  }
