...
public class MizarVariableIdentifierImpl extends ASTWrapperPsiElement implements MizarVariableIdentifier {

  public MizarVariableIdentifierImpl(@NotNull ASTNode node) {
    super(node);
  }
