...
public class MizarReservedIdentifiersImpl extends ASTWrapperPsiElement implements MizarReservedIdentifiers {

  public MizarReservedIdentifiersImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MizarVisitor visitor) {
    visitor.visitReservedIdentifiers(this);
  }
