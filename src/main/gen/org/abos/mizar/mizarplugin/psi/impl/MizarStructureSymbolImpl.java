...
public class MizarStructureSymbolImpl extends ASTWrapperPsiElement implements MizarStructureSymbol {

  public MizarStructureSymbolImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MizarVisitor visitor) {
    visitor.visitStructureSymbol(this);
  }
