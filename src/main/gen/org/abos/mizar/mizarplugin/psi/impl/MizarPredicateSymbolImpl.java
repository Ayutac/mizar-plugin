...
public class MizarPredicateSymbolImpl extends ASTWrapperPsiElement implements MizarPredicateSymbol {

  public MizarPredicateSymbolImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MizarVisitor visitor) {
    visitor.visitPredicateSymbol(this);
  }
