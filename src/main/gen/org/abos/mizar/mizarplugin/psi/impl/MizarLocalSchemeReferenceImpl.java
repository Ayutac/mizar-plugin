...
public class MizarLocalSchemeReferenceImpl extends ASTWrapperPsiElement implements MizarLocalSchemeReference {

  public MizarLocalSchemeReferenceImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MizarVisitor visitor) {
    visitor.visitLocalSchemeReference(this);
  }
