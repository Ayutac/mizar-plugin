...
public class MizarReductionRegistrationImpl extends ASTWrapperPsiElement implements MizarReductionRegistration {

  public MizarReductionRegistrationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MizarVisitor visitor) {
    visitor.visitReductionRegistration(this);
  }
