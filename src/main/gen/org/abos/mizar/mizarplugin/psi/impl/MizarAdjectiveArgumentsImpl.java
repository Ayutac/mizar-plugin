...
public class MizarAdjectiveArgumentsImpl extends ASTWrapperPsiElement implements MizarAdjectiveArguments {

  public MizarAdjectiveArgumentsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MizarVisitor visitor) {
    visitor.visitAdjectiveArguments(this);
  }
  ...
  public MizarTermExpressionList getTermExpressionList() {
    return findNotNullChildByClass(MizarTermExpressionList.class);
  }
