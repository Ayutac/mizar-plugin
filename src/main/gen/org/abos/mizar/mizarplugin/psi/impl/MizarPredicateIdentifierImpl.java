...
public class MizarPredicateIdentifierImpl extends ASTWrapperPsiElement implements MizarPredicateIdentifier {

  public MizarPredicateIdentifierImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MizarVisitor visitor) {
    visitor.visitPredicateIdentifier(this);
  }
