...
public class MizarStraightforwardJustificationImpl extends ASTWrapperPsiElement implements MizarStraightforwardJustification {

  public MizarStraightforwardJustificationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MizarVisitor visitor) {
    visitor.visitStraightforwardJustification(this);
  }
