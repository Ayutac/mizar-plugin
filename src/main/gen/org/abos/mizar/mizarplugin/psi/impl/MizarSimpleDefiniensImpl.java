...
public class MizarSimpleDefiniensImpl extends ASTWrapperPsiElement implements MizarSimpleDefiniens {

  public MizarSimpleDefiniensImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MizarVisitor visitor) {
    visitor.visitSimpleDefiniens(this);
  }
