...
public class MizarAdjectiveImpl extends ASTWrapperPsiElement implements MizarAdjective {

  public MizarAdjectiveImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MizarVisitor visitor) {
    visitor.visitAdjective(this);
  }
  ...
  @Override
  @Nullable
  public MizarAdjectiveArguments getAdjectiveArguments() {
    return findChildByClass(MizarAdjectiveArguments.class);
  }
