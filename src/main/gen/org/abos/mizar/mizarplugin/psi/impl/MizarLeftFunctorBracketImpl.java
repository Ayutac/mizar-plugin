...
public class MizarLeftFunctorBracketImpl extends ASTWrapperPsiElement implements MizarLeftFunctorBracket {

  public MizarLeftFunctorBracketImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MizarVisitor visitor) {
    visitor.visitLeftFunctorBracket(this);
  }
