...
public class MizarReservationSegmentImpl extends ASTWrapperPsiElement implements MizarReservationSegment {

  public MizarReservationSegmentImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MizarVisitor visitor) {
    visitor.visitReservationSegment(this);
  }
  ...
  @Override
  @NotNull
  public MizarReservedIdentifiers getReservedIdentifiers() {
    return findNotNullChildByClass(MizarReservedIdentifiers.class);
  }
