...
public class MizarJustificationImpl extends ASTWrapperPsiElement implements MizarJustification {

  public MizarJustificationImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public MizarProof getProof() {
    return findChildByClass(MizarProof.class);
  }
