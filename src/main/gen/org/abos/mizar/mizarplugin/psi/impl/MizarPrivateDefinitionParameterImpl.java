...
public class MizarPrivateDefinitionParameterImpl extends ASTWrapperPsiElement implements MizarPrivateDefinitionParameter {

  public MizarPrivateDefinitionParameterImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MizarVisitor visitor) {
    visitor.visitPrivateDefinitionParameter(this);
  }
