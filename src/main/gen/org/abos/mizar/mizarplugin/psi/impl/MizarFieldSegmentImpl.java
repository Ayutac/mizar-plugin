...
public class MizarFieldSegmentImpl extends ASTWrapperPsiElement implements MizarFieldSegment {

  public MizarFieldSegmentImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MizarVisitor visitor) {
    visitor.visitFieldSegment(this);
  }
  ...
  @Override
  @NotNull
  public List<MizarSelectorSymbol> getSelectorSymbolList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, MizarSelectorSymbol.class);
  }
