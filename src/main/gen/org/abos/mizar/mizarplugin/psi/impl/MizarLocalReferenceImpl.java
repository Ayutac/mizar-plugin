...
public class MizarLocalReferenceImpl extends ASTWrapperPsiElement implements MizarLocalReference {

  public MizarLocalReferenceImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public MizarLabelIdentifier getLabelIdentifier() {
    return findNotNullChildByClass(MizarLabelIdentifier.class);
  }
