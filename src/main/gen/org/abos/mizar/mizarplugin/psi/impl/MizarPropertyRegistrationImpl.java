...
public class MizarPropertyRegistrationImpl extends ASTWrapperPsiElement implements MizarPropertyRegistration {

  public MizarPropertyRegistrationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MizarVisitor visitor) {
    visitor.visitPropertyRegistration(this);
  }
