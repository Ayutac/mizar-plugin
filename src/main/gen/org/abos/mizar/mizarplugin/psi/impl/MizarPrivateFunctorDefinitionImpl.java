...
public class MizarPrivateFunctorDefinitionImpl extends ASTWrapperPsiElement implements MizarPrivateFunctorDefinition {

  public MizarPrivateFunctorDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MizarVisitor visitor) {
    visitor.visitPrivateFunctorDefinition(this);
  }
  ...
  @Override
  @NotNull
  public MizarPrivateFunctorPattern getPrivateFunctorPattern() {
    return findNotNullChildByClass(MizarPrivateFunctorPattern.class);
  }
