...
public class MizarSentenceImpl extends ASTWrapperPsiElement implements MizarSentence {

  public MizarSentenceImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public MizarFormulaExpression getFormulaExpression() {
    return findNotNullChildByClass(MizarFormulaExpression.class);
  }
