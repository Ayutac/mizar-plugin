...
public class MizarFunctorIdentifierImpl extends ASTWrapperPsiElement implements MizarFunctorIdentifier {

  public MizarFunctorIdentifierImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MizarVisitor visitor) {
    visitor.visitFunctorIdentifier(this);
  }
