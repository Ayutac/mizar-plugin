...
public class MizarTheoremImpl extends ASTWrapperPsiElement implements MizarTheorem {

  public MizarTheoremImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public MizarCompactStatement getCompactStatement() {
    return findNotNullChildByClass(MizarCompactStatement.class);
  }
