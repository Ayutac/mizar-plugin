...
public class MizarCaseListImpl extends ASTWrapperPsiElement implements MizarCaseList {

  public MizarCaseListImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<MizarCase> getCaseList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, MizarCase.class);
  }
