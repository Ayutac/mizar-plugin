...
public class MizarLinkableStatementImpl extends ASTWrapperPsiElement implements MizarLinkableStatement {

  public MizarLinkableStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MizarVisitor visitor) {
    visitor.visitLinkableStatement(this);
  }
  ...
  @Override
  @Nullable
  public MizarChoiceStatement getChoiceStatement() {
    return findChildByClass(MizarChoiceStatement.class);
  }
  ...
  @Override
  @Nullable
  public MizarTypeChangingStatement getTypeChangingStatement() {
    return findChildByClass(MizarTypeChangingStatement.class);
  }
