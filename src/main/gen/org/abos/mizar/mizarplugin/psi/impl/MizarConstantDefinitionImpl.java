...
public class MizarConstantDefinitionImpl extends ASTWrapperPsiElement implements MizarConstantDefinition {

  public MizarConstantDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public MizarEquatingList getEquatingList() {
    return findNotNullChildByClass(MizarEquatingList.class);
  }
