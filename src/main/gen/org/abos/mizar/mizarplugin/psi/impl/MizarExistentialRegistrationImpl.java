...
public class MizarExistentialRegistrationImpl extends ASTWrapperPsiElement implements MizarExistentialRegistration {

  public MizarExistentialRegistrationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MizarVisitor visitor) {
    visitor.visitExistentialRegistration(this);
  }
