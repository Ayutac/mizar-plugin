...
public class MizarArticleNameImpl extends ASTWrapperPsiElement implements MizarArticleName {

  public MizarArticleNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MizarVisitor visitor) {
    visitor.visitArticleName(this);
  }
