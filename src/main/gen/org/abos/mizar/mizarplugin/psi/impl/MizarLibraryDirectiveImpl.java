...
public class MizarLibraryDirectiveImpl extends ASTWrapperPsiElement implements MizarLibraryDirective {

  public MizarLibraryDirectiveImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<MizarArticleName> getArticleNameList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, MizarArticleName.class);
  }
