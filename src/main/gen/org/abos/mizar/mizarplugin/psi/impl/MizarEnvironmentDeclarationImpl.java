...
public class MizarEnvironmentDeclarationImpl extends ASTWrapperPsiElement implements MizarEnvironmentDeclaration {

  public MizarEnvironmentDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<MizarDirective> getDirectiveList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, MizarDirective.class);
  }
