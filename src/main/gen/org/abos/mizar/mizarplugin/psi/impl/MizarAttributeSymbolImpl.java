...
public class MizarAttributeSymbolImpl extends ASTWrapperPsiElement implements MizarAttributeSymbol {

  public MizarAttributeSymbolImpl(@NotNull ASTNode node) {
    super(node);
  }
