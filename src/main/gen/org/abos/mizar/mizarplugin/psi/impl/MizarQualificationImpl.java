...
public class MizarQualificationImpl extends ASTWrapperPsiElement implements MizarQualification {

  public MizarQualificationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MizarVisitor visitor) {
    visitor.visitQualification(this);
  }
