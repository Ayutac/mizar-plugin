...
public class MizarSchemeNumberImpl extends ASTWrapperPsiElement implements MizarSchemeNumber {

  public MizarSchemeNumberImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MizarVisitor visitor) {
    visitor.visitSchemeNumber(this);
  }
