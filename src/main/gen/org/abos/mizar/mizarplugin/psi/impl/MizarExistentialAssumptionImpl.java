...
public class MizarExistentialAssumptionImpl extends ASTWrapperPsiElement implements MizarExistentialAssumption {

  public MizarExistentialAssumptionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MizarVisitor visitor) {
    visitor.visitExistentialAssumption(this);
  }
