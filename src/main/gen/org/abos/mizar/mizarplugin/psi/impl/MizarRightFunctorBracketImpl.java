...
public class MizarRightFunctorBracketImpl extends ASTWrapperPsiElement implements MizarRightFunctorBracket {

  public MizarRightFunctorBracketImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MizarVisitor visitor) {
    visitor.visitRightFunctorBracket(this);
  }
