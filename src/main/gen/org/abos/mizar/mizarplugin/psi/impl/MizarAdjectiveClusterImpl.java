...
public class MizarAdjectiveClusterImpl extends ASTWrapperPsiElement implements MizarAdjectiveCluster {

  public MizarAdjectiveClusterImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MizarVisitor visitor) {
    visitor.visitAdjectiveCluster(this);
  }
