...
public class MizarModeSymbolImpl extends ASTWrapperPsiElement implements MizarModeSymbol {

  public MizarModeSymbolImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MizarVisitor visitor) {
    visitor.visitModeSymbol(this);
  }
