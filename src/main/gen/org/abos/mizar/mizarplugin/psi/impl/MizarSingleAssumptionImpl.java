...
public class MizarSingleAssumptionImpl extends ASTWrapperPsiElement implements MizarSingleAssumption {

  public MizarSingleAssumptionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MizarVisitor visitor) {
    visitor.visitSingleAssumption(this);
  }
