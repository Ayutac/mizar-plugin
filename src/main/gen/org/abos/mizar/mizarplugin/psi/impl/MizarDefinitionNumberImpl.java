...
public class MizarDefinitionNumberImpl extends ASTWrapperPsiElement implements MizarDefinitionNumber {

  public MizarDefinitionNumberImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MizarVisitor visitor) {
    visitor.visitDefinitionNumber(this);
  }
