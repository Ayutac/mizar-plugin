...
public class MizarAttributeLociImpl extends ASTWrapperPsiElement implements MizarAttributeLoci {

  public MizarAttributeLociImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MizarVisitor visitor) {
    visitor.visitAttributeLoci(this);
  }
  ...
  public MizarLoci getLoci() {
    return findNotNullChildByClass(MizarLoci.class);
  }
