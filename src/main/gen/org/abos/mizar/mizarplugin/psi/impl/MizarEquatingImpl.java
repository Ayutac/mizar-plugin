...
public class MizarEquatingImpl extends ASTWrapperPsiElement implements MizarEquating {

  public MizarEquatingImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MizarVisitor visitor) {
    visitor.visitEquating(this);
  }
  ...
  public MizarVariableIdentifier getVariableIdentifier() {
    return findNotNullChildByClass(MizarVariableIdentifier.class);
  }
