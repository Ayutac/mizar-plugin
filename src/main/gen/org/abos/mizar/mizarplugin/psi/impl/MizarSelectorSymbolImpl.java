...
public class MizarSelectorSymbolImpl extends ASTWrapperPsiElement implements MizarSelectorSymbol {

  public MizarSelectorSymbolImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MizarVisitor visitor) {
    visitor.visitSelectorSymbol(this);
  }
