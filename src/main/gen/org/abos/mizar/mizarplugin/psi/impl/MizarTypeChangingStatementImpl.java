...
public class MizarTypeChangingStatementImpl extends ASTWrapperPsiElement implements MizarTypeChangingStatement {

  public MizarTypeChangingStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MizarVisitor visitor) {
    visitor.visitTypeChangingStatement(this);
  }
  ...
  @Override
  @NotNull
  public MizarTypeChangeList getTypeChangeList() {
    return findNotNullChildByClass(MizarTypeChangeList.class);
  }
