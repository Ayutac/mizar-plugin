...
public class MizarGeneralizationImpl extends ASTWrapperPsiElement implements MizarGeneralization {

  public MizarGeneralizationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MizarVisitor visitor) {
    visitor.visitGeneralization(this);
  }
