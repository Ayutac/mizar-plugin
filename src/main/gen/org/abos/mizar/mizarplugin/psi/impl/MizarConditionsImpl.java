...
public class MizarConditionsImpl extends ASTWrapperPsiElement implements MizarConditions {

  public MizarConditionsImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<MizarProposition> getPropositionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, MizarProposition.class);
  }
