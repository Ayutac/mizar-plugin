...
public class MizarDiffuseConclusionImpl extends ASTWrapperPsiElement implements MizarDiffuseConclusion {

  public MizarDiffuseConclusionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MizarVisitor visitor) {
    visitor.visitDiffuseConclusion(this);
  }
  ...
  public MizarReasoning getReasoning() {
    return findChildByClass(MizarReasoning.class);
  }
