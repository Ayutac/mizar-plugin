...
public class MizarLabelIdentifierImpl extends ASTWrapperPsiElement implements MizarLabelIdentifier {

  public MizarLabelIdentifierImpl(@NotNull ASTNode node) {
    super(node);
  }
