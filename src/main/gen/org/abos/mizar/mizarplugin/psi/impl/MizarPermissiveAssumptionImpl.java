...
public class MizarPermissiveAssumptionImpl extends ASTWrapperPsiElement implements MizarPermissiveAssumption {

  public MizarPermissiveAssumptionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MizarVisitor visitor) {
    visitor.visitPermissiveAssumption(this);
  }
  ...
  public MizarAssumption getAssumption() {
    return findNotNullChildByClass(MizarAssumption.class);
  }
