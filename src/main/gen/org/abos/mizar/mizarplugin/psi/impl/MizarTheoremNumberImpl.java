...
public class MizarTheoremNumberImpl extends ASTWrapperPsiElement implements MizarTheoremNumber {

  public MizarTheoremNumberImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MizarVisitor visitor) {
    visitor.visitTheoremNumber(this);
  }
