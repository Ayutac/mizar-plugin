...
public class MizarSchemeIdentifierImpl extends ASTWrapperPsiElement implements MizarSchemeIdentifier {

  public MizarSchemeIdentifierImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MizarVisitor visitor) {
    visitor.visitSchemeIdentifier(this);
  }
