...
public class MizarPostQualifiedVariableImpl extends ASTWrapperPsiElement implements MizarPostQualifiedVariable {

  public MizarPostQualifiedVariableImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MizarVisitor visitor) {
    visitor.visitPostQualifiedVariable(this);
  }
