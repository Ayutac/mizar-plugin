...
public class MizarSchemeConclusionImpl extends ASTWrapperPsiElement implements MizarSchemeConclusion {

  public MizarSchemeConclusionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MizarVisitor visitor) {
    visitor.visitSchemeConclusion(this);
  }
